...
namespace KOTORModSync.Core.Services
{
	...
	public class ModManagementService
	{
		...
		{
			if (sourceComponent is null) throw new ArgumentNullException(nameof(sourceComponent));
		...
		{
			if (component is null || dependencyComponent is null) return false;
		...
		{
			if (component is null || restrictionComponent is null) return false;

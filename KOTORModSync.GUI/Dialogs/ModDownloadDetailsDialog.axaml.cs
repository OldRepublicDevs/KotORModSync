...
.ConfigureAwait( false );
				...
				await Clipboard.SetTextAsync( errorDetails ).ConfigureAwait( false );
...
.ConfigureAwait( false );
...

			{
				...
				await InformationDialog.ShowInformationDialogAsync( this, $"Failed to retry download: {ex.Message}" ).ConfigureAwait( false );
			}
		}

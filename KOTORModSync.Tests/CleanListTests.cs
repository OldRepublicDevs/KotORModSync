...
namespace KOTORModSync.Tests
{
	...
	public class CleanListTests
	{
		...
		public async Task Test_CleanList_DeletesExpectedFiles_BasedOnSelectedMods()
		{
			...
			{
				File.WriteAllText(Path.Combine(overrideDir, f), "dummy");
			}
			...
			File.WriteAllText(cleanlistPath, csv);
			...
			try
			{
				...
				Instruction cleanList = new Instruction
				{
				...
				await vfs.InitializeFromRealFileSystemAsync(_workDir).ConfigureAwait(false);
